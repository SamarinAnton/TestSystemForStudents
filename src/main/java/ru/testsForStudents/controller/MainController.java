...
public class MainController {
    ...
    public ModelAndView helloPage(@ModelAttribute("user") User userModel,
                                  ModelAndView model) {

        if(userModel != null){
            if(userModel.getStatus() == User.Status.STUDENT)
                return new ModelAndView("redirect:/tasks/testing");
            else if(userModel.getStatus() == User.Status.TEACHER)
    ...
    @GetMapping("/exit")
    public String exit(@ModelAttribute("user") User userModel){
        userModel = null;
        return "redirect:/index";
    }
}